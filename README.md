...
## Projects
- **[Machine learning model for binary classification](https://github.com/harimshin/data-science-portfolio/blob/main/machine_learning_binary_classification_with_SMOTE_prediction_model_for_the_severity_of_car_accidents.ipynb)**<br>
...
- **Machine Learning & Big Data:** Scikit-learn, PySpark, TensorFlow, PyTorch, Keras, Numpy, Pandas; Algorithm: Logistic &
Multivariate Regression, Random Forest, Gradient Boosting, Neural Network
- **Statistical Analysis & Causal Inference:** Hypothesis Testing, Time Series Analysis, A/B Testing, Difference-in-
Differences, Propensity Score Matching, Instrumental Variables, Regression Discontinuity Design
- **Marketing Analytics:** Marketing Mix Modeling (MMM), Multi-Touch Attribution (MTA), Market Segmentation,
...
- **Development Tools & Documentation:** Google Colab, Jupyter Notebook, RStudio; LaTeX, Git
...
**Digital Marketing Lead / Business Analayst @ Kakao Entertainment (Seoul, Korea) (_May 2013 - Feb 2015_)**
